  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-2 p-1.5 rounded-full bg-muted hover:bg-accent transition-colors btn-press"
      >
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[320px] max-w-[calc(100vw-2rem)] bg-card rounded-xl shadow-xl border border-border z-50 overflow-hidden dropdown-enter">
          {/* Header */}
          ...
          <div className="px-4 py-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div key={s.label} className="flex items-center gap-2 p-2 rounded-lg bg-muted/50 text-sm row-hover">
          ...
          <div className="p-2 space-y-0.5">
            <Button
              variant="ghost"
              className="w-full justify-start gap-2 h-9 text-sm btn-press"
