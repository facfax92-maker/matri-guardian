...
import { Heart, Activity, Loader2, CheckCircle } from 'lucide-react';
        ...
        <div className="w-full max-w-md text-center page-enter">
          <Card className="border-0 shadow-lg">
            <CardContent className="pt-8 pb-8 space-y-4">
              <CheckCircle className="h-16 w-16 text-success mx-auto success-check" />
              ...
              <Link to="/login">
                <Button variant="outline" className="mt-4 btn-press">Back to Login</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md page-enter">
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 gradient-primary text-primary-foreground px-4 py-2 rounded-2xl mb-4 list-item-in">
            <Heart className="h-5 w-5" />
            <Activity className="h-4 w-4 opacity-80" />
            <span className="text-xl font-bold tracking-tight">MatriCare</span>
          </div>
          <p className="text-muted-foreground list-item-in" style={{ animationDelay: '80ms' }}>Create your account</p>
        </div>

        <Card className="border-0 shadow-lg list-item-in" style={{ animationDelay: '120ms' }}>
